...
const Following: NextPage = () => {
    ...
    const getFollowing = api.follows.getFollowingForUser.useQuery(
    ...
    const PageHead = useMemo(
        () => (
            <Head>
                <title>{`People following by ${username} - Twitty`}</title>
        ...
        <>
            ...
            <Layout>
                <div className='w-[600px]'>
                    ...
                    <FollowsList follows={getFollowing.data} isLoading={getFollowing.isLoading} />
                </div>
            </Layout>
        </>
    );
